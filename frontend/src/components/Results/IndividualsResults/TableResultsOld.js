...
function TableResultsIndividuals(props) {
    ...
    const columns = [
        ...
        { field: 'measures', headerName: 'measures', width: 350, headerClassName: 'super-app-theme--header', cellClass: 'pre' },
        { field: 'sex', headerName: 'sex', width: 200, headerClassName: 'super-app-theme--header' },
        { field: 'diseases', headerName: 'diseases', width: 350, headerClassName: 'super-app-theme--header' },
    ...
    props.results.forEach((element, index) => {
        ...
        if (element[1] !== undefined) {
            ...
            if (element[1].geographicOrigin !== '' && element[1].geographicOrigin !== undefined) {
            ...
            if (element[1].measures !== '' && element[1].measures !== undefined) {
                ...
                if (typeof (element[1].measures) === 'object') {
                    ...
                    element[1].measures.forEach(element2 => {
                        ...
                        measuresJson.push(JSON.stringify(element2, null, 2).replace('[', "").replace(']', ""))


                    })

                } else {
                    measuresJson = JSON.stringify(element[1].measures, null, 2).replace('[', "").replace(']', "")
                }
            ...
            if (element[1].interventionsOrProcedures !== '' && element[1].interventionsOrProcedures !== undefined) {

                if (typeof (element[1].interventionsOrProcedures) === 'object') {

                    element[1].interventionsOrProcedures.forEach(element2 => {
                        interventionsProcedures.push(JSON.stringify(element2, null, 2).replace('[', "").replace(']', ""))
                    })

                } else {
                    interventionsProcedures = JSON.stringify(element[1].interventionsOrProcedures, null, 2).replace('[', "").replace(']', "")
                }
        }
            ...
            if (element[1].diseases !== '' && element[1].diseases !== undefined) {
                ...
                if (typeof (element[1].diseases) === 'object') {
                    ...
                    element[1].diseases.forEach(element2 => {
                        ...
                        diseases.push(JSON.stringify(element2, null, 2).replace('[', "").replace(']', ""))

                    })

                } else {
                    diseases = JSON.stringify(element[1].diseases, null, 2).replace('[', "").replace(']', "")
                }
