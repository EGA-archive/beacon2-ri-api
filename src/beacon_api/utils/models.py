...
from .. import __service__, __serviceUrl__, __entryPoint__, __open__, __service_type__, __documentationUrl__, __environment__, __type_group__, __type_artifact__, __type_version__, __baseUrl__
...
def GA4GH_ServiceInfo_v01(host):
    GA4GH_ServiceInfo_v01 = {
        ...
        'name': __beacon_name__,
        'type': {
            'group': __type_group__,
            'artifact': __type_artifact__,
            'version': __type_version__
        },
        'description': __description__,
